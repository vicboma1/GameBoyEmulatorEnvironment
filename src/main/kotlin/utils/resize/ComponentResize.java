 ...
 *  of the component.
 */
public class ComponentResize extends MouseAdapter
{
     ...
     */
    public ComponentResize(Component... components)
    {
     ...
     *  @param components components to be automatically registered
     */
    public ComponentResize(Insets dragInsets, Component... components)
    {
     ...
     *  @param components components to be automatically registered
     */
    public ComponentResize(Insets dragInsets, Dimension snapSize, Component... components)
    {
