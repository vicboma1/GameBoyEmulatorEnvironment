...
class TableModelImpl internal constructor(val columnNames : Array<String>, val data: Array<Array<Any>>, var isEditable : Boolean = false ): AbstractTableModel() {

    companion object {
        fun create(columnNames: Array<String>, data: Array<Array<Any>>) = TableModelImpl(columnNames, data)
    }
